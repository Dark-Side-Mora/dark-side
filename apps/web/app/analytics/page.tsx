...
const LineChart = ({ color = "var(--accent-cyan)" }) => (
  <svg viewBox="0 0 400 150" style={{ width: "100%", height: "150px" }}>
    ...
    <defs>
      <linearGradient
        id={`gradient-${color.replace("var(--", "").replace(")", "")}`}
        x1="0"
        y1="0"
        x2="0"
        y2="1"
    ...
    <div style={{ padding: "20px" }}>
      <div style={{ marginBottom: "32px" }}>
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: "14px" }}>
          Deep-dive into your CI/CD performance and efficiency metrics.
        </p>
      </div>
      ...
      >
        ...
        <Card title="Optimization Insights">
          ...
          >
            Switching to <strong>ARM64 runners</strong> could reduce build costs
            by 24% while maintaining similar performance for node-based
            applications.
          </p>
          <div
            style={{
          ...
          >
            Parallelizing test suites will shave off approximately{" "}
            <strong>52 seconds</strong> from the critical path.
          </p>
        </Card>
      </div>
      <p>Analytics dashboard content coming soon...</p>
    </div>
  );
}
