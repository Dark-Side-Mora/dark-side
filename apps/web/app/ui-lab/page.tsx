...
export default function UILabPage() {
  return (
    <div style={{ padding: "20px" }}>
      <h1 className="text-2xl font-bold mb-8">UI Component Lab</h1>
      <div style={{ marginBottom: "48px" }}>
        <h2 style={{ fontSize: "28px", fontWeight: 800, marginBottom: "8px" }}>
          UI Elements (Figma Library)
        </h2>
        <p style={{ color: "var(--text-secondary)", fontSize: "14px" }}>
          Capture these modular components for your Figma design system.
        </p>
      </div>
      ...
      >
        <div>
          ...
          <ModalPreview title="Confirm Deletion">
            ...
            >
              ...
              ? This action is irreversible and will stop all active jobs.
            </p>
          </ModalPreview>
        </div>
        ...
        <div>
          ...
          <Card
            ...
            style={{ width: "200px", padding: "8px", marginTop: "40px" }}
          >
            {["View Details", "Rerun Pipeline", "Archive", "Delete"].map(
              (item, i) => (
                <div
                  key={item}
                  style={{
